...
export SETUP_METRICS=$SETUP_METRICS
export METRICS_SERVER=$METRICS_SERVER
export INFLUXDB_VERSION=$influxdb.version
export INFLUXDB_MD5=$influxdb.md5.hash
export GRAFANA_VERSION=$grafana.version
export GRAFANA_MD5=$grafana.md5.hash
...
export INFLUXDB_TARBALL=influxdb_"$$INFLUXDB_VERSION"_x86_64.tar.gz
export INFLUXDB_INSTALL=$$INSTALL_DIR/influxdb_"$$INFLUXDB_VERSION"_x86_64
export GRAFANA_TARBALL=grafana-"$$GRAFANA_VERSION".linux-x64.tar.gz
export GRAFANA_INSTALL=$$INSTALL_DIR/grafana-"$$GRAFANA_VERSION"
